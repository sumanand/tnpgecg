...
import { Briefcase, DollarSign, MapPin, Calendar, Users, Award, Send, FileText } from 'lucide-react';
...
const PostJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const driveRef = push(ref(db, 'placement_drives'));
      await set(driveRef, {
        ...formData,
      ...
      await set(notificationRef, {
        ...
        message: `${formData.company} is hiring for ${formData.title}. Apply now!`,
        createdAt: new Date().toISOString(),
        read: false
      });
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Post a New Job Opening</h2>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Eligible Branches (Ctrl+Click for multiple)
                      </label>
                      <select
                        multiple
                ...
                <div className="border-t pt-6 space-y-6">
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white flex items-center">
                    <FileText className="w-5 h-5 mr-2 text-blue-600 animate-pulse" />
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all transform hover:scale-[1.02] disabled:opacity-50 flex items-center justify-center"
                >
